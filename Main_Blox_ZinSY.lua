...
local Tabs = {
    ...
    Fram = Window:AddTab({ Title = "Farm", Icon = "sword" }),
...
local listfastattack = {'0.40 - Siêu Chậm','0.30 - Hơi Chậm','0.20 - Bình Thương','0.15 - Hơi Nhanh','0.10 - Siêu Nhanh'}

    local DropdownDelayAttack = Tabs.Main:AddDropdown("DropdownDelayAttack", {
        Title = "Chọn Mode Đánh",
        Values = listfastattack,
        Multi = false,
        Default = 1,
    })
    DropdownDelayAttack:SetValue("0. - Bình Thường")
    DropdownDelayAttack:OnChanged(function(Value)
    _G.FastAttackFaiFao_Mode = Value
	if _G.FastAttackZinSY_Mode == "Bình Thường" then
		_G.Fast_Delay = 0.20
	elseif _G.FastAttackZinSY_Mode == "Siêu Chậm" then
		_G.Fast_Delay = 0.40
	elseif _G.FastAttackZinSY_Mode == "Hơi Chậm" then
		_G.Fast_Delay = 0.30
	elseif _G.FastAttackZinSY_Mode == "Hơi Nhanh" then
		_G.Fast_Delay = 0.25	
	elseif _G.FastAttackZinSY_Mode == "Siêu Nhanh" then
		_G.Fast_Delay = 0.10
	end
end)
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Auto Cày Level", Default = false })
    ...
    spawn(function()
        ...
        pcall(function()
          ...
          if BypassTP then
            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude > 2400 then
            BTP(CFrameQ)
            elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude < 2400 then
            Tween(CFrameQ)
            end
                else
              Tween(CFrameQ)
              end
          if (CFrameQ.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4 then
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {Title = "Auto Đánh Hải Tặc", Default = false })
...
local ToggleChestTween = Tabs.Main:AddToggle("ToggleChestTween", {Title = "Auto Nhặt Rương [BAY]", Default = false })
...
----------------------------------------------------------------------------------------------------------------------------------------------
      ...
      Tabs.Main:AddButton({
        Title = "Nhập Code",
        Description = "Nhập Tất Cả code x2 exp",
        Callback = function()
            UseCode()
        end
    })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Auto Trái Blox Mastery", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    if First_Sea then
		tableBoss = {"TruongVinh244 Raid Boss [Lv. 7000]","The Gorilla King","Bobby","Yeti","Mob Leader","Vice Admiral","Warden","Chief Warden","Swan","Magma Admiral","Fishman Lord","Wysper","Thunder God","Cyborg","Saber Expert"}
	elseif Second_Sea then
		tableBoss = {"TruongVinh244 Raid Boss [Lv. 8000]","Diamond","Jeremy","Fajita","Don Swan","Smoke Admiral","Cursed Captain","Darkbeard","Order","Awakened Ice Admiral","Tide Keeper"}
	elseif Third_Sea then
		tableBoss = {"TruongVinh244 Raid Boss [Lv. 9000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
	end
    ...
    if First_Sea then
        MaterialList = {
          "Sắt Vụn","Da","Cánh T.Thần","Quặng Magma","Đuôi Cá"
        } elseif Second_Sea then
        MaterialList = {
          "Sắt Vụn","Da","V.Chất Phóng Xạ","Nước Mắt","Quặng Magma","Răng Nanh"
        } elseif Third_Sea then
        MaterialList = {
          "Sắt Vụn","Da","Lửa Bóng Tối","Bột Cocoa","Vẩy Rồng","Thuốc Súng","Đuôi Cá","Sừng Tê Giác"
        }
        end
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Auto Farm Nguyên Liệu", Default = false })
    ...
    spawn(function()
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "Tới Đảo Kitsune", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Lấy Azure Ambers", Default = false })
...
if Third_Sea then
    ...
    spawn(function()
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = " Giết Shark", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Giết Ship", Default = false })
...
local ToggleAutoW = Tabs.Main:AddToggle("ToggleAutoW", {Title = "Auto Ấn W", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Auto Đảo Bí Ẩn", Default = false })
ToggleMirage:OnChanged(function(Value)
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Auto Nhấn W", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Auto Lữu Hái [Fully]", Default = false })
...
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Auto Nâng Cận Chiến", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Auto Nâng Phòng Thủ", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Auto Nâng Kiếm", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Auto Nâng Súng", Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Auto Nâng Blox Fruit", Default = false })
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Tp Tới Player", Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Nhìn Trộm Player", Default = false })
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Lưu Trữ Fruit", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Nhặt Devil Fruit", Default = false })
...
local ToggleEspPlayer = Tabs.Fruit:AddToggle("ToggleEspPlayer", {Title = "Định Vị Player", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Định Vị Fruit", Default = false })
...
Tabs.Misc:AddButton({
	...
	Callback = function()
		...
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
		game.Players.LocalPlayer.PlayerGui.Farm.AwakeningToggler.Visible = true
		game:GetService("Players").LocalPlayer.PlayerGui.Farm.AwakeningToggler.Position = UDim2.new(0.48, 10, 0.908, 2)
		game:GetService("Players").LocalPlayer.PlayerGui.Farm.AwakeningToggler.Size = UDim2.new(1, 0, 0.22, 0)
	
	
		pcall(function()
			game:GetService("Players").LocalPlayer.PlayerGui.Farm.MenuButton.Visible = false
		end)
		pcall(function()
			game:GetService("Players").LocalPlayer.PlayerGui.Farm.RaceEnergy.Visible = false
		end)
		pcall(function()
			game:GetService("Players").LocalPlayer.PlayerGui.Farm.SafeZone.Visible = false
		end)
		pcall(function()
			game:GetService("Players").LocalPlayer.PlayerGui.Farm.HP.Visible = false
		end)
		pcall(function()
			game:GetService("Players").LocalPlayer.PlayerGui.Backpack.Enabled.Visible = false
		end)
		pcall(function()
			game:GetService("Players").LocalPlayer.PlayerGui.Farm.Energy.Visible = false
		end)
		for k, v in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Farm:GetChildren()) do
			if v:IsA("ImageButton") then
				v:Destroy()
			end
		end
		pcall(function()
			game:GetService("Players").LocalPlayer.PlayerGui.Farm.Compass.Visible = false
		end)
	end
})
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("Qua Sea 3 Để Chức Năng Này Hoạt Động")
end
...
spawn(function()
    while wait() do
        if _G.AutoBone then
            pcall(function()
                local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Farm.Quest.Container.QuestTitle.Title.Text
                if not string.find(QuestTitle, "Demonic Soul") then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                end
                if game:GetService("Players").LocalPlayer.PlayerGui.Farm.Quest.Visible == false then
                    if BypassTP then
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Farm.Quest.Visible == true then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Farm.Quest.Container.QuestTitle.Title.Text, "Demonic Soul") then
                                        repeat wait(_G.Fast_Delay)
                                            AttackNoCD()
                                            AutoHaki()
                                            bringmob = true
                                            ...
                                            FarmPos = v.HumanoidRootPart.CFrame
                                            MonFarm = v.Name
                                        until not _G.AutoBone or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Farm.Quest.Visible == false
                                    else
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        bringmob = false
                                    end
...
local ToggleCake = Tabs.Farm:AddToggle("ToggleCake", {Title = "Auto Cake Prince", Default = false })
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.Farm:AddToggle("ToggleSpawnCake", {Title = "Auto Hồi Sinh Cake Prince", Default = true })
