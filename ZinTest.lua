...
local listfastattack = {'0.40 - Siêu Chậm','0.30 - Hơi Chậm','0.20 - Bình Thương','0.15 - Hơi Nhanh','0.10 - Siêu Nhanh'}
    ...
    DropdownDelayAttack:SetValue("0.15 - Hơi Nhanh")
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.Main:AddToggle("ToggleSpawnCake", {Title = "Auto Hồi Sinh Cake Prince", Default = true })
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("Qua Sea 3 Nhé Anh Bạn")
end
...
----------------------------------------------------------------------------------------------------------------------------------------------
local Mastery = Tabs.Info:AddSection("Xin Chào Tôi Là Trương Vinh")
local Mastery = Tabs.Info:AddSection("Hãy Theo Dõi Tiktok Tôi @vinhroblox244")